...
struct femtoDreamTripletTaskTrackTrackTrack {
  ...
  Configurable<int> confmultNtrMin{"confmultNtrMin", 40, "Minimum multNtr Percentile"};
  Configurable<int> confmultNtrMax{"confmultNtrMax", 10000, "Maximum multNtr Percentile"};

  Filter EventSelection = aod::femtodreamcollision::sphericity >= confSphericityMin && aod::femtodreamcollision::sphericity <= confSphericityMax && aod::femtodreamcollision::multNtr >=confmultNtrMin && aod::femtodreamcollision::multNtr <= confmultNtrMax;
  ...
  void fillCollision(CollisionType col)
  {
    ...
    ThreeBodyQARegistry.fill(HIST("TripletTaskQA/SphericityVsMultNtr"), col.sphericity(), col.multNtr());
