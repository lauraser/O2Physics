  ...
  void fillCollisionsAndTracksAndV0AndCascade(CollisionType const& col, TrackType const& tracks, TrackTypeWithItsPid const& tracksWithItsPid, V0Type const& fullV0s, CascadeType const& fullCascades)
  {
    ...
    */
    ...
    for (auto& track : tracksWithItsPid) {
      ...
      /*if(track.tpcChi2NCl() < ConfTrkMinChi2PerClusterTPC || track.tpcChi2NCl()> ConfTrkMaxChi2PerClusterTPC){
        continue;
      }
      if(track.itsChi2NCl()> ConfTrkMaxChi2PerClusterITS){
        continue;
      }
      if( (ConfTrkTPCRefit && !track.hasTPC()) || (ConfTrkITSRefit && !track.hasITS())){
        continue;
      }*/
